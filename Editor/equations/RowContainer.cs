...
namespace Editor
{
    public class RowContainer : EquationContainer, ISupportsUndo
    {
        ...
        double LineSpace
        {
            get
            {
                return lineSpaceFactor * FontSize;
            }
        }

        public EquationBase FirstRow
        {
            get
            {
                return childEquations.First();
            }
        }
        public EquationBase LastRow
        {
            get
            {
                return childEquations.Last();
            }
        }
        ...
        public override EquationBase Split(EquationContainer newParent)
        {
            ...
            if (newRow != null)
            {
                ...
                var rca = new RowContainerAction(this, childEquations.IndexOf(activeRow), activeRow.ActiveChildIndex, activeRow.TextLength, newRow)
                {
                    UndoFlag = false
                };
