...
namespace Editor
{
    public class Box : EquationContainer
    {
        ...
        Point LeftTop
        {
            get
            {
                return new Point(Left + LeftPadding / 2, Top + TopPadding / 2);
            }
        }
        Point RightTop
        {
            get
            {
                return new Point(Right - RightPadding / 2, Top + TopPadding / 2);
            }
        }
        Point LeftBottom
        {
            get
            {
                return new Point(Left + LeftPadding / 2, Bottom - BottomPadding / 2);
            }
        }
        Point RightBottom
        {
            get
            {
                return new Point(Right - RightPadding / 2, Bottom - BottomPadding / 2);
            }
        }
