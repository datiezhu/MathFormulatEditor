...
namespace Editor
{
    public abstract class EquationBase
    {
        ...
        public virtual bool ApplySymbolGap
        {
            get;
            set;
        }

        public virtual HashSet<int> GetUsedTextFormats()
        {
            return null;
        }
        ...
        protected double LineThickness
        {
            get
            {
                return fontSize * lineFactor;
            }
        }
        protected double ThinLineThickness
        {
            get
            {
                return fontSize * lineFactor * 0.7;
            }
        }
        protected Pen StandardPen
        {
            get
            {
                return PenManager.GetPen(LineThickness);
            }
        }
        protected Pen ThinPen
        {
            get
            {
                return PenManager.GetPen(ThinLineThickness);
            }
        }

        protected Pen StandardMiterPen
        {
            get
            {
                return PenManager.GetPen(LineThickness, PenLineJoin.Miter);
            }
        }
        protected Pen ThinMiterPen
        {
            get
            {
                return PenManager.GetPen(ThinLineThickness, PenLineJoin.Miter);
            }
        }

        protected Pen StandardRoundPen
        {
            get
            {
                return PenManager.GetPen(LineThickness, PenLineJoin.Round);
            }
        }
        protected Pen ThinRoundPen
        {
            get
            {
                return PenManager.GetPen(ThinLineThickness, PenLineJoin.Round);
            }
        }
        ...
        public static bool ShowNesting
        {
            get;
            set;
        }
        public EquationContainer ParentEquation
        {
            get;
            set;
        }
        ...
        {
            get;    //this is a directed value (as on a real line!!)
            set;
        }
        ...
        public virtual bool ConsumeMouseClick(Point mousePoint)
        {
            return false;
        }
        public virtual void HandleMouseDrag(Point mousePoint) { }

        public virtual EquationBase Split(EquationContainer newParent)
        {
            return null;
        }
        ...
        public virtual bool ConsumeKey(Key key)
        {
            return false;
        }
        public virtual Point GetVerticalCaretLocation()
        {
            return location;
        }
        public virtual double GetVerticalCaretLength()
        {
            return height;
        }
        ...
        public virtual bool Select(Key key)
        {
            return false;
        }
        ...
        public virtual CopyDataObject Copy(bool removeSelection)
        {
            return null;    //copy & cut
        }
